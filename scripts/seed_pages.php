...
$pages = [
    ...
    [
        ...
        'translations' => [
            'en' => [
                'title'           => 'About Us',
                'content'         => 'Optilarity operates on a 100% remote model — transparent, flexible, and unrestricted by geography. Our team members work from countries around the world, united by a single purpose: to deliver real value to our customers.' . "\n\n" . 'We have no fixed headquarters — and that is a deliberate choice. A globally distributed model allows us to attract the best talent, wherever they may be. In the future, we may establish offices in strategic locations as our scale and business needs evolve.' . "\n\n" . 'Today, we channel our full energy into two core disciplines: technical excellence and customer support — the twin pillars of our team\'s strength and our commitment to every client we serve.',
                'seo_title'       => 'About Optilarity – 100% Remote Global Team',
                'seo_description' => 'Optilarity is a fully remote, globally distributed team specializing in technical excellence and customer support.',
            ],
            'vi' => [
                'title'           => 'Về chúng tôi',
                'content'         => 'Optilarity vận hành theo mô hình 100% remote — minh bạch, linh hoạt và không giới hạn bởi địa lý. Các thành viên trong đội ngũ của chúng tôi làm việc từ nhiều quốc gia khác nhau trên thế giới, kết nối bởi cùng một mục tiêu: mang lại giá trị thực sự cho khách hàng.' . "\n\n" . 'Chúng tôi không có trụ sở cố định — và đó là lựa chọn có chủ đích. Mô hình phân tán toàn cầu cho phép chúng tôi tuyển chọn những người giỏi nhất, bất kể họ đang ở đâu. Trong tương lai, chúng tôi có thể mở văn phòng tại một số địa điểm chiến lược khi quy mô và nhu cầu kinh doanh cho phép.' . "\n\n" . 'Hiện tại, chúng tôi tập trung toàn lực vào hai lĩnh vực cốt lõi là kỹ thuật và hỗ trợ khách hàng — đây là thế mạnh của đội ngũ và là cam kết của chúng tôi với từng khách hàng.',
                'seo_title'       => 'Về Optilarity – Đội ngũ Global 100% Remote',
                'seo_description' => 'Optilarity vận hành 100% remote với đội ngũ kỹ thuật và support toàn cầu. Minh bạch, chuyên nghiệp và tận tâm với từng khách hàng.',
            ],
            'ja' => [
                'title'           => '私たちについて',
                'content'         => 'Optilarity は完全リモートモデルで運営されています。透明性が高く、柔軟で、地理的な制約を受けません。私たちのチームメンバーは世界中のさまざまな国で活動し、ひとつの目標に向かって結束しています。それは、お客様に真の価値を届けることです。' . "\n\n" . '固定の本社を持たないのは、意図的な選択です。グローバルに分散したチーム体制により、場所を問わず最高の人材を集めることができます。将来的には、事業規模やニーズに応じて戦略的な拠点にオフィスを開設する可能性があります。' . "\n\n" . '現在は、技術力とカスタマーサポートという二つのコア領域に全力を注いでいます。これが私たちの強みであり、すべてのお客様へのコミットメントです。',
                'seo_title'       => 'Optilarity について – 100% リモートのグローバルチーム',
                'seo_description' => 'Optilarity は、技術とサポートに特化した完全リモートのグローバルチームです。',
            ],
            'ko' => [
                'title'           => '회사 소개',
                'content'         => 'Optilarity는 100% 원격 근무 모델로 운영됩니다. 투명하고 유연하며, 지리적 경계에 제한받지 않습니다. 저희 팀원들은 전 세계 여러 나라에서 근무하며, 하나의 목표를 공유합니다. 바로 고객에게 실질적인 가치를 전달하는 것입니다.' . "\n\n" . '고정 본사가 없는 것은 의도적인 선택입니다. 글로벌 분산 모델을 통해 지역에 관계없이 최고의 인재를 확보할 수 있습니다. 향후 사업 규모와 필요에 따라 전략적 위치에 사무소를 개설할 수도 있습니다.' . "\n\n" . '현재 저희는 기술 역량과 고객 지원이라는 두 가지 핵심 분야에 전력을 집중하고 있습니다. 이것이 저희 팀의 강점이자 모든 고객에 대한 약속입니다.',
                'seo_title'       => 'Optilarity 소개 – 100% 원격 글로벌 팀',
                'seo_description' => 'Optilarity는 기술 및 고객 지원에 특화된 완전 원격 글로벌 팀입니다.',
            ],
            'fr' => [
                'title'           => 'À propos de nous',
                'content'         => 'Optilarity fonctionne selon un modèle entièrement en télétravail — transparent, flexible et affranchi des contraintes géographiques. Les membres de notre équipe travaillent depuis de nombreux pays à travers le monde, unis par un seul objectif : apporter une valeur concrète à nos clients.' . "\n\n" . 'L\'absence de siège fixe est un choix délibéré. Un modèle distribué à l\'échelle mondiale nous permet de recruter les meilleurs talents, où qu\'ils se trouvent. À l\'avenir, nous pourrons ouvrir des bureaux dans des emplacements stratégiques en fonction de l\'évolution de nos activités.' . "\n\n" . 'Aujourd\'hui, nous concentrons toute notre énergie sur deux disciplines fondamentales : l\'excellence technique et le support client — les deux piliers de notre équipe et de notre engagement envers chacun de nos clients.',
                'seo_title'       => 'À propos d\'Optilarity – Équipe mondiale 100% remote',
                'seo_description' => 'Optilarity est une équipe mondiale entièrement distribuée, spécialisée dans l\'excellence technique et le support client.',
            ],
        ],
    ],
    ...
    [
        ...
        'translations' => [
            'en' => [
                ...
                'seo_title'       => 'Contact Optilarity',
                'seo_description' => 'Get in touch with the Optilarity team for technical support, partnerships, or general inquiries.',
            ],
            'vi' => [
                'title'           => 'Liên hệ',
                ...
                'seo_title'       => 'Liên hệ Optilarity',
                'seo_description' => 'Liên hệ với đội ngũ Optilarity để được hỗ trợ kỹ thuật, hợp tác kinh doanh hoặc giải đáp thắc mắc.',
            ],
            'ja' => [
                'title'           => 'お問い合わせ',
                ...
                'seo_title'       => 'お問い合わせ – Optilarity',
                'seo_description' => '技術サポートやパートナーシップのご相談など、Optilarity チームへのお問い合わせはこちら。',
            ],
            'ko' => [
                'title'           => '문의하기',
                ...
                'seo_title'       => '문의하기 – Optilarity',
                'seo_description' => '기술 지원, 파트너십 또는 일반 문의를 위해 Optilarity 팀에 연락하세요.',
            ],
            'fr' => [
                ...
                'seo_title'       => 'Contactez Optilarity',
                'seo_description' => 'Contactez l\'équipe Optilarity pour un support technique, un partenariat ou toute autre demande.',
            ],
        ],
    ],
...
foreach ($pages as $pageConfig) {
    ...
    $exists = $db->table('optilarity_static_pages')
        ->where('slug', $slug)
        ->run()
        ->fetch();

    if (!$exists) {
        $id = $db->insert('optilarity_static_pages')->values($mainData)->run();
        echo "[OK] Seeded main: {$defaultTrans['title']}\n";
    } else {
        $id = $exists['id'];
        unset($mainData['created_at']);
        $db->update('optilarity_static_pages', $mainData, ['id' => $id])->run();
    ...
    foreach ($pageConfig['translations'] as $lang => $transData) {
        ...
        $transExists = $db->table('optilarity_translations_static_pages')
            ->where('static_page_id', $id)
            ->where('language', $lang)
            ->count();

        if ($transExists === 0) {
            $db->insert('optilarity_translations_static_pages')->values($transRecord)->run();
            echo "  -> Seeded [{$lang}]: {$transData['title']}\n";
        } else {
            unset($transRecord['static_page_id'], $transRecord['language']);
            $db->update('optilarity_translations_static_pages', $transRecord, [
                'static_page_id' => $id,
                'language'       => $lang,
            ])->run();
